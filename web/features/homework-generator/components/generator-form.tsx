    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_400px]">
      ...
      <div className="rounded-xl border border-[#e3e3df] bg-white p-5 shadow-[0_1px_2px_rgba(0,0,0,.02)] sm:p-6">
        ...
        <div className="mt-5 space-y-5">
          ...
          <label className="flex cursor-pointer items-center justify-between rounded-lg border border-[#e4e4e0] p-3.5"><span><span className="block text-[13px] font-medium">Додати відповіді</span><span className="mt-0.5 block text-[12px] text-[#898983]">Наприкінці документа</span></span><input className="size-4 accent-[#22221f]" defaultChecked type="checkbox" /></label>
          <button className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[#20201d] text-sm font-medium text-white transition hover:bg-[#383834] disabled:cursor-not-allowed disabled:opacity-50" disabled={!example.trim()} onClick={onGenerate} type="button"><Sparkles size={16} /> Згенерувати задачі</button>
